...
function search(){
	...
	request.open("Post", "http://localhost:8080/estimate/searchfacilities?searchword=" + searchword, true);
...
function insertcheck(){
	...
	if (facilities_name.value == ""){
		alert("확인");
		return false;
	}
	
	if (facilities_status.value == ""){
		alert("확인");
		return false;
	}
	...
	if (using_all_day.value == ""){
		alert("확인");
		return false;
	}
	if (using_all_day.value == 'N'){
		if (facilities_start.value == ""){
			alert("확인");
			return false;
		}
		if (facilities_end.value == ""){
			alert("확인");
			return false;
		}
	}
